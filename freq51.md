...
You must have a node that has compute.
A [femtofox](https://github.com/femtofox/femtofox), a network connected node, or a portduino node of some kind.

### Node Configuration
Hops: 7  
Unmessagalbe/Infrastructure: Off  
